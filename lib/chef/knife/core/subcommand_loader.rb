    ...
    class SubcommandLoader
      ...
      def self.for_config(chef_config_dir)
        if autogenerated_manifest?
          Knife::SubcommandLoader::HashedCommandLoader.new(chef_config_dir, ENV, plugin_manifest)
        elsif custom_manifest?
          Knife::SubcommandLoader::CustomManifestLoader.new(chef_config_dir, ENV, plugin_manifest)
        else
          Knife::SubcommandLoader::GemGlobLoader.new(chef_config_dir, ENV)
        end
      end
